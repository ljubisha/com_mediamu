...
<div id="fm_breadcrumbs">
    ...
    <?php foreach($this->breadcrumbs as $bc) : ?>
        ...
        <?php if(!$first_bc) : ?> 
            &GT;
       <?php endif; ?>
        <a href="index.php?option=com_mediamu&view=dir&tmpl=component&dir=<?php echo $bc->link; ?>"><?php echo $bc->name ?></a></li>
    ...
    <div id="folder_input_form">
        <form id="input_form" action="" method="post">
            ...
            <input id="create_folder" type="submit" value="<?php echo JText::_('COM_MEDIAMU_DIR_BROSWER_BTN_CREATE'); ?>" />
